...
namespace BGSK1
{
    public sealed class ReportsCenterForm : Form
    {
        ...
        public ReportsCenterForm()
        {
            ...
            ThemeHelper.StyleButton(b2, ThemeHelper.Secondary);
            ThemeHelper.StyleButton(b3, ThemeHelper.Success);
            ThemeHelper.StyleButton(b4, Color.FromArgb(24, 88, 146));
            ThemeHelper.StyleButton(be, ThemeHelper.Accent);
            ThemeHelper.StyleButton(bf, ThemeHelper.Danger);
            ThemeHelper.StyleButton(bp, Color.FromArgb(27, 111, 173));
            ThemeHelper.StyleButton(br, Color.FromArgb(96, 120, 148));
